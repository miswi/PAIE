...
from models.paie import PAIE
from models.single_prompt import BartSingleArg
...
# train_examples, train_features, train_dataloader, args.train_invalid_num = processor.generate_dataloader('test')
# model, tokenizer, optimizer, scheduler = build_model(args=args, model_type = 'base')