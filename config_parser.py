...
def get_args_parser():
    ...
    parser.add_argument("--model_name_or_path", default=r"E:\Code File\Pre-train-Model\torchVersion\bart-base", type=str,
    ...
    parser.add_argument("--role_path", default=r'E:\Code File\Pytorch\NLP\Paper code\PAIE-main\data\dset_meta\description_rams.csv', type=str,
    ...
    parser.add_argument('--inference_model_path', default=r"E:\Code File\Pytorch\NLP\Paper code\PAIE-main\outputs_res\checkpoint", type=str,
