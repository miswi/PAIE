...
class DSET_processor:
    ...
    def generate_dataloader(self, set_type):
        ...
        if set_type == 'train':
            file_path = self.args.train_file   # r'E:\Code File\Pytorch\NLP\Paper code\Code Reconstr\PAIE\data\RAMS_1.0\data\train.jsonlines'
        elif set_type == 'dev':
            file_path = self.args.dev_file  # r'E:\Code File\Pytorch\NLP\Paper code\Code Reconstr\PAIE\data\RAMS_1.0\data\dev.jsonlines'
        else:
            file_path = self.args.test_file  # r'E:\Code File\Pytorch\NLP\Paper code\Code Reconstr\PAIE\data\RAMS_1.0\data\test.jsonlines'
...
# tokenizer = BartTokenizerFast.from_pretrained(r"E:\Code File\Pre-train-Model\torchVersion\bart-base")
# args = get_args_parser()
# processor = DSET_processor(args, tokenizer)
